...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UserSource = {
	  ...
	  validatePromotion: function validatePromotion(code) {
	    return _axios2.default.put(_utils.ApiHelper.apiUrl('promotions/validate'), {
	      'code': code
	    }).then(function (res) {
	      return res.data;
	    });
	            ...
	            case true:
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement('input', { type: 'hidden', id: 'access_token', name: 'access_token', value: _this3.props.currentUser }),
