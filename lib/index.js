...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.Root = exports.TextField = exports.SignUp = exports.SignOut = exports.Signin = exports.ShopifyAuth = exports.ResponsiveDialog = exports.RefundDialog = exports.Notice = exports.ForgottenPassword = exports.ChangePassword = exports.Button = exports.Authenticate = exports.Admin = undefined;
	...
	var _Root2 = __webpack_require__(186);
	...
	var Root = (_temp = _class = function (_React$Component) {
	  ...
	  function Root(props) {
	    ...
	    if (props.location.query.ref) {
	      var referrer = encodeURIComponent(props.location.query.ref);
	      document.cookie = 'ref=' + referrer + '; path=/; max-age=2592000'; // one month
	      window.location = props.ifReferrerLocation;
	    } else {
	      if (_stores.UserStore.getState().authenticated) window.location = props.ifAuthenticatedLocation;else window.location = props.ifUnauthenticatedLocation;
	    }
