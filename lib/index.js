...
})(this, function(__WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_37__, __WEBPACK_EXTERNAL_MODULE_38__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RefundDialog2 = __webpack_require__(39);
	
	var _RefundDialog3 = _interopRequireDefault(_RefundDialog2);
	
	var _ResponsiveDialog2 = __webpack_require__(35);
	
	var _ResponsiveDialog3 = _interopRequireDefault(_ResponsiveDialog2);
	
	var _Admin2 = __webpack_require__(36);
	...
	var Admin = function (_React$Component) {
	  ...
	  _createClass(Admin, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _actions.UserAdminActions.search('');
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RefundDialog = function (_React$Component) {
	  ...
	  _createClass(RefundDialog, [{
	    key: 'onValidSubmit',
	    value: function onValidSubmit(data) {
	      var _this2 = this;
	
	      data["user_id"] = this.props.userId;
	      this.setState({ loading: true });
	      _actions.UserAdminActions.makeRefund(data).then(function (data) {
	        _this2.setState({ loading: false, refundOkOpen: true });
	      }).catch(function (error) {
	        _this2.setState({ refundError: error.response.data, loading: false });
	      });
	    }
	  }, {
	    key: 'handleRefundDialogClose',
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          _materialUi.Dialog,
	          {
	            ...
	            modal: false,
	            actions: React.createElement(_materialUi.RaisedButton, { label: 'OK', onTouchTap: this.handleRefundDialogClose })
	          },
	          React.createElement(
	            'p',
	            null,
